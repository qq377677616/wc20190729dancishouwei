...
Page({
     ...
     */
    data: {
        resourcesUrl: `${wx.getStorageSync("resourcesUrl")}/images/europe/`,
        imgList: [
            'page4_2.png', 'page4_3.png', 'page4_4.png', 'page4_10.png', 'page4_5.png',
            'page4_6.png', 'page4_11.png', 'page4_7.png', 'page4_8.png', 'page4_9.png',
        ],
        timeoutNum: 0,//延迟变亮处理-1
        leftList: [440, 773, 945, 890, 525, 387, 57, 741,520,728],
        rotate: 0,
    ...
    onLoad: function (options) {
      ...
      axios.post('Index/get_city', { rdSession: rdSession, state: state }).then(res => {
        ...
        let width = res.data.data.num == 7 ? 10 : 240;
        _this.setData({
      ...
      if(this.data.repeat){
        ...
        query.exec(function (res) {
          ...
          let timer = setTimeout(() => { // 气球点亮延迟
            ...
            // wx.redirectTo({ url: '/pages/subject/ten/index?id=' + 9755 })

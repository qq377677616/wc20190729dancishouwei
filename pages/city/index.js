...
Page({
  ...
  btns:function(e){
    ...
    if(index==0){
      wx.navigateTo({url: '../decorate/asia/index'})
    }else if(index==1){
      wx.navigateTo({ url: '../decorate/europe/index' })
    } else if (index == 2) {
      wx.navigateTo({ url: '../decorate/africa/index' })
    } else if (index == 3) {
      wx.navigateTo({ url: '../decorate/north/index' })
    }
  },
